    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden md:flex md:w-1/2 flex-col bg-[#9B7EA4] relative">
        ...
        <div className="relative z-10 flex flex-col items-end mt-32">
          <Link
            href="/login"
            className="px-16 py-4 text-2xl font-extrabold tracking-wide text-[#d4c2d9] uppercase mr-4 cursor-pointer"
          >
            Log In
          </Link>
          <Link
            href="/signup"
            className="bg-[#d4c2d9] px-16 py-4 rounded-l-full text-2xl font-extrabold tracking-wide text-black uppercase mt-2 cursor-pointer"
          >
            Sign Up
          </Link>
        </div>
              ...
              <form onSubmit={handleVerify} className="flex flex-col gap-6">
                ...
                <div className="border-b border-gray-300 pb-2">
                  <input
                    ...
                    required
                    className="w-full bg-transparent text-lg text-black outline-none placeholder:text-gray-500 text-center tracking-widest"
                  />
                </div>
